...
function homePage() {
    ...
    restaurantTagLine.textContent = 'Taste the pleasure of authentic Indonesian cuisine, with ingredients and spices that can only be obtained in Indonesia, only at Sumber Barokah restaurant. asdasdasd';
